<?php
/**
 * Helper Functions - DYNAMIC MODAL BASED ON TYPE
 */
        ...
        <div class="preset-modal-content">
            ...
            <form id="preset-form" method="post" action="">
                ...
                <div class="preset-tab-content active" data-tab="general">
                    ...
                    <!-- POST CATEGORIES - Show only for posts -->
                    ...
                    <!-- PRODUCT CATEGORIES - Show only for products -->
                    <?php if (class_exists('WooCommerce')) : ?>
                ...
                <!-- Display Tab - DYNAMIC BASED ON TYPE -->
                ...
                <!-- Styling Tab - DYNAMIC BASED ON TYPE -->
                <div class="preset-tab-content" data-tab="styling">
                    ...
                    <div class="field-products-only" style="display:none;">
                    ...
                    <!-- READ MORE BUTTON STYLING (Posts) -->
                    <div class="field-posts-only">
                    ...
                    <!-- ADD TO CART BUTTON STYLING (Products) -->
                    <div class="field-products-only" style="display:none;">
